...
cutBase   = 'tag_lep_pt > 25. && probe_triggerMatch > 0.5 && probe_lep_charge < 0. ' ## cuts already applied in the tree

# flag to be Tested
cutpassMuSelection = '( probe_lep_fullLepId > 0.5 )'

# flag to be Tested
flags = {
    'selectionMu_minus' : cutpassMuSelection,
    }
