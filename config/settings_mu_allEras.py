...
#############################################################
# flag to be Tested
cutpassTrigMu = '( probe_muTrgPt  > -1 || probe_tkMuTrgPt > -1)'

# flag to be Tested
flags = {
    'triggerMu'  : cutpassTrigMu,
    }
baseOutDir = 'results/muFullData/'
...
samplesDef = {
    'data'   : tnpSamples.wmass_80X['mu_Run2016B'].clone(),
    'mcNom'  : tnpSamples.wmass_80X['mu_DY'].clone(),
    'mcAlt'  : None, #tnpSamples.ICHEP2016['mc_DY_amcatnlo_ele'].clone(),
    'tagSel' : None, #tnpSamples.ICHEP2016['mc_DY_madgraph_ele'].clone(),
}
## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.wmass_80X['mu_Run2016C'] )
samplesDef['data'].add_sample( tnpSamples.wmass_80X['mu_Run2016D'] )
samplesDef['data'].add_sample( tnpSamples.wmass_80X['mu_Run2016E'] )
samplesDef['data'].add_sample( tnpSamples.wmass_80X['mu_Run2016F'] )
samplesDef['data'].add_sample( tnpSamples.wmass_80X['mu_Run2016G'] )
samplesDef['data'].add_sample( tnpSamples.wmass_80X['mu_Run2016H'] )
...
#binning_eta = [0.0, 0.2, 0.3, 0.5, 0.8, 1.2]
binning_pt  = [26, 28, 30, 33, 36, 39, 42, 45]
...
#############################################################
### cut
cutBase   = 'tag_lep_pt > 26 ' ## cuts already applied in the tree
